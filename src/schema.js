// TODO: figure out how to encopirate schema.proto and protobuf.js

var pblite = require('./pblite'),
	Field = () => new pblite.Field,
	BooleanField = () => new pblite.BooleanField,
	EnumField = enms => new pblite.EnumField(enms),
	RepeatedField = field => new pblite.RepeatedField(field),
	Message = arr => new pblite.Message(arr.map(e=>e===Field?Field():e)),
	s = {},
	blank = ''
...
s.Place = {
	url: 1,                     // Google Maps URL pointing to the map coordinates.
	name: 3,                    // Name of map location.
	representative_image: 185,  // Representative image of the place (map with pin).
}
...
s.CLIENT_HANGOUT_EVENT = Message([
	...
	'transferred_conversation_id', Field,
...
s.CLIENT_STATE_UPDATE = Message([
	...
	'conversation_notification', Field,
	...
	'client_conversation_notification', s.CLIENT_CONVERSATION,
